...
${OBJECTDIR}/ActRelu.o: ActRelu.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ActRelu.o ActRelu.cpp

${OBJECTDIR}/ActSigmoid.o: ActSigmoid.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ActSigmoid.o ActSigmoid.cpp
...
${OBJECTDIR}/LayerConvolution.o: LayerConvolution.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LayerConvolution.o LayerConvolution.cpp

${OBJECTDIR}/LayerFC.o: LayerFC.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LayerFC.o LayerFC.cpp

${OBJECTDIR}/LayerPool.o: LayerPool.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LayerPool.o LayerPool.cpp

${OBJECTDIR}/PoolAverage.o: PoolAverage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PoolAverage.o PoolAverage.cpp

${OBJECTDIR}/PoolMax.o: PoolMax.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PoolMax.o PoolMax.cpp
